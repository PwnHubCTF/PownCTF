        ...
        <tbody>
          ...
          >
            ...
            <td>
              ...
              <Button v-if="!challenge.hidden" :loading="loading" @clicked="setHideChallenge(challenge, true)" class="w-16 bg-green-500">
                <svg
                  fill="currentColor"
                  width="16"
                  height="16"
              ...
              <Button v-else :loading="loading" @clicked="setHideChallenge(challenge, false)" class="w-16 bg-red-500">
                <svg
                  fill="currentColor"
                  width="16"
                  height="16"
